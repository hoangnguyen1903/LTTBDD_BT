...
const Screen1 = ({ navigation }) => {
    ...
    return <View style={{ width: '100%', height: '100%' }}>
        ...
        <View style={{flexDirection: "row", alignItems: 'center', paddingHorizontal: '15px', paddingVertical: '10px', borderWidth: '1px', borderStyle: 'solid', marginTop: '40px', marginHorizontal: '15px'}}>
            ...
            <TextInput placeholder="Enter your name" placeholderTextColor="rgba(0,0,0,0.3)" style={{outlineStyle: "none", marginLeft: '10px'}} value={name} onChangeText={(text) => setName(text)} />
        </View>
        <TouchableOpacity 
